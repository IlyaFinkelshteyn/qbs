...
public:
    ...
    {
        const auto qbsSettings = project.projectConfiguration()[QStringLiteral("qbs")].toMap();
        return qbsSettings[QStringLiteral("architecture")].toString();
    }
    ...
    {
        const auto qbsSettings = project.projectConfiguration()[QStringLiteral("qbs")].toMap();
        return qbsSettings[QStringLiteral("configurationName")].toString();
    }
