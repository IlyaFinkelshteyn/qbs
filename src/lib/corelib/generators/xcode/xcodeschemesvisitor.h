...
#ifndef XCODESCHEMESVISITOR_H
#define XCODESCHEMESVISITOR_H
...
class XcodeSchemesVisitor : public IGeneratableProjectVisitor {
public:
    XcodeSchemesVisitor(QSharedPointer<PBXProject> xcodeProject)
