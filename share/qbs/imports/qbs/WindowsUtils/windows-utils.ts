...
export function characterSetDefines(charset: string) {
    var defines: string[] = [];
    if (charset === "unicode")
...
export function isValidWindowsVersion(systemVersion: string) {
...
export function getWindowsVersionInFormat(systemVersion: string, format: string) {
