...
Module {
    ...
    Rule {
        ...
        Artifact {
            ...
            fileTags: ["application", "codesign.signed_artifact"]
        }
    ...
    Rule {
        ...
        Artifact {
            filePath: input.moduleProperty("qbs", "_moduleData_filePath")
            fileTags: ["dynamiclibrary", "codesign.signed_artifact"]
        }
    ...
    Rule {
        ...
        Artifact {
            filePath: input.moduleProperty("qbs", "_moduleData_filePath")
            fileTags: ["loadablemodule", "codesign.signed_artifact"]
        }
    ...
    Rule {
        inputs: ["unsigned_bundle"]

        Artifact {
            filePath: input.moduleProperty("qbs", "_moduleData_filePath")
            fileTags: ["bundle", "codesign.signed_artifact"]
        }
